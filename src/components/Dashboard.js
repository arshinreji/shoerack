...
function Dashboard() {
  ...
  <Link  className='text-white text-decoration-none' to={`/dashboard2`}> <li className="page-item"><a className="page-link" >2</a></li></Link>
  <Link  className='text-white text-decoration-none' to={`/dashboard2`}> <li className="page-item"><a className="page-link" >Next</a></li></Link>
  </ul>
</nav>
    </div>
        </Col>
